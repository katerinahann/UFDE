...
@Module({imports:[ConfigModule.forRoot({isGlobal:true,validate:validateEnvironment}),ThrottlerModule.forRoot([{name:'default',ttl:60000,limit:120}])],controllers:[HealthController,ContentController,FormsController,AdminController],providers:[PrismaService,ContactMailService,AdminGuard,{provide:APP_GUARD,useClass:ThrottlerGuard}]}) export class AppModule {}
